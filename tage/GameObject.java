...
public class GameObject {
    ...
    /**
     * Builds a GameObject with specified parent node and ObjShape, with texture
     * set to null.
     */
    ...
    /**
     * Builds a GameObject with specified parent node, ObjShape, and
     * TextureImage.
     */
    ...
    /**
     * assigns a TextureImage height map to this GameObject - applicable to
     * terrain planes
     */
     ...
     */
    public void setRenderStates(RenderStates r) {
        renderStates = r;
    }

    /**
     * returns a boolean value that is true if this GameObject is a terrain
     * plane
     */
    ...
    /**
     * Orients this GameObject so that it faces a location specified in a
     * Vector3f
     */
    ...
    /**
     * copies a specified Matrix4f into this GameObject's local translation
     * matrix
     */
    ...
    /**
     * applies the parent rotation when building this GameObject's world
     * rotation matrix
     */
    ...
    /**
     * applies the parent scale when building this GameObject's world scale
     * matrix
     */
    ...
    /**
     * returns a boolean that is true if the object applies its parent's
     * rotation to its position
     */
    ...
    /**
     * returns a boolean that is true if the object applies its parent's scale
     * to its position
     */
    ...
    // --------------- added functions by M. Saechao -------------
    /**
     * creates new rotation transformation matrix of given rotation (float)
     * degrees around own y-axis, then uses setLocalRotation to set local
     * rotation to current local rotation multiplied by new matrix
     */
    public void yaw(float rot) {
        this.setLocalRotation(this.getLocalRotation().mul((new Matrix4f()).rotation(rot, 0, 1, 0)));
    }

    /**
     * creates new rotation transformation matrix of given rotation (float)
     * degrees around world's y-axis, then uses setLocalRotation to set local
     * rotation to current local rotation multiplied by new matrix
     */
    public void globalYaw(float rot) {
        this.setLocalRotation(this.getWorldRotation().mul((new Matrix4f()).rotation(rot, 0, 1, 0)));
    }

    /**
     * creates new rotation transformation matrix of given rotation (float)
     * degrees around own x-axis, then uses setLocalRotation to set local
     * rotation to current local rotation multiplied by new matrix
     */
    public void pitch(float rot) {
        this.setLocalRotation(this.getLocalRotation().mul((new Matrix4f()).rotation(rot, 1, 0, 0)));
    }

    public void roll(float rot) {
        this.setLocalRotation(this.getLocalRotation().mul((new Matrix4f()).rotation(rot, 0, 0, 1)));
    }
