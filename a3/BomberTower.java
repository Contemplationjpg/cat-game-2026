...
public class BomberTower extends TowerType {
    ...
    private final double projDelay = 1.5f;
    private final double pickupDelay = 5.0;
    private final float projStrength = 100.0f;
    private double attackTimer;
    private double pickupTimer;

    // public BomberTower(String s) {
    //     super(s);
    // }
    // public BomberTower(String n, ObjShape m) {
    //     super(n, m);
    // }
    // public BomberTower(String n, String mStr) {
    //     super(n, mStr);
    // }
    public BomberTower(MyGame g, Tower t, String n, ObjShape m, TextureImage ti) {
        super(g, t, n, m, ti);
        createNewBomb();
    }

    // public BomberTower(String n, String mStr, TextureImage t) {
    //     super(n, mStr, t);
    // }
    // public BomberTower(String n, ObjShape m, String tStr) {
    //     super(n, m, tStr);
    // }
    // public BomberTower(String n, String mStr, String tStr) {
    //     super(n, mStr, tStr);
    // }
    ...
    private void createNewBomb() {
        if (projectile == null && tower != null) {
            ...
            game.getTowerManager().addBomb(projectileP);
