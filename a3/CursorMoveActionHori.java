...
public class CursorMoveActionHori extends AbstractInputAction {
    ...
    public CursorMoveActionHori(MyGame g, Boolean c, Boolean f) {
    ...
    public CursorMoveActionHori(MyGame g, Boolean c) {
        // System.out.println("initialized fwd action");
        game = g;
        isController = c;
    }
